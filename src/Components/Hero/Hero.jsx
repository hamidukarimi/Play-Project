import heroImage from "../../assets/img/hero/hero-image.jpg";
function Hero() {
  return (
    <div className="h-auto bg-[#3758f9] pt-20">
      <div className="  flex flex-col items-center justify-center gap-12">
        <div className="flex flex-col items-center justify-center mt-16 gap-6">
          <div>
            <h1 className="text-3xl w-[100%] px-3 sm:text-4xl sm:w-[600px] lg:text-5xl font-bold text-center text-white lg:w-[735px] lg:leading-[1.2]">
              Open-Source Web Template for SaaS, Startup, Apps, and More
            </h1>
          </div>
          <div>
            <h2 className="text-sm w-[100%] px-3 sm:text-lg sm:w-[450px] lg:text-lg font-semibold text-center text-white lg:w-[595px]">
          ...
          <div className="flex gap-5">
            <a href="https://hkarimi.vercel.app/" target="_blank">
              <button className="bg-white py-3 px-5 rounded-md text-sm font-semibold hover:bg-gray-100 hover:text-gray-600 duration-200">
              Download Now
            </button>
            </a>

            <a href="https://hkarimi.vercel.app/" target="_blank">
            <button className="bg-[#dedada29] flex items-center justify-center gap-3 text-white py-3 px-5 rounded-md text-sm font-semibold hover:bg-gray-100 hover:text-black duration-200">
              <svg
          ...
          <div className="flex items-center justify-center gap-3">
            <svg
              className="fill-current text-white/60 hover:text-white cursor-pointer duration-300"
              width="35"
              height="33"
              viewBox="0 0 41 32"
              fill="none"
            ...
            <svg
              className="fill-current cursor-pointer text-white/60 hover:text-white duration-300"
              width="35"
              height="33"
              viewBox="0 0 41 26"
              fill="none"
            ...
            <svg
              className="mt-0.5 fill-current cursor-pointer text-white/60 hover:text-white duration-300"
              width="35"
              height="33"
              viewBox="0 0 30 38"
              fill="none"
        ...
        <div className="w-[80%] relative sm:w-[60%]">
          <img
            src={heroImage}
